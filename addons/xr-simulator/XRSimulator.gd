...
var left_tracker: XRControllerTracker   # just change type
var right_tracker: XRControllerTracker  # just change type
...
func _ready():
	...
	if left_hand == null:
		...
		left_tracker = XRControllerTracker.new()    # create controller-tracker
	...
	if right_hand == null:
		...
		right_tracker = XRControllerTracker.new()   # create controller-tracker	
